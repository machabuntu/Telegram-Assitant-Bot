                ...
                "messages": [
                    {
                        ...
                        "content": [
                            {
                                "type": "text",
                                "text": "Опиши это изображение на русском языке. Если на картинке изображен мем, попытайся понять и объяснить его Если на нем есть персонажи, попытайся определить их. Ответ не более 2000 символов."
                            },
                            {
                                "type": "image_url",
                                "image_url": {
