...
OUTPAINT_USER = """\
Расширь изображение методом outpaint до портретного соотношения сторон 5:7 (ширина к высоте). \
Сохрани всё исходное содержимое без искажений; главный объект, лицо или важная часть сцены \
должны оказаться в верхней части итогового кадра. \
Дорисованный фон должен органично продолжать сцену, без рамок, текста и водяных знаков. \
Верни только итоговое изображение, без комментариев."""
