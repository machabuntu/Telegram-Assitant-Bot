    ...
    async def validate_participants_with_ai(self, participants: list, bans: list) -> list:
        ...
        try:
            ...
            prompt = (
                ...
                "7) Способен ли персонаж манипулировать концепциями: наносить концептуальный урон, "
                "иметь концептуальную защиту, изменять или стирать саму идею/сущность противника "
                "(урон или защита на уровне понятий, а не только физики)?\n"
                "Если по чеклисту получено хотя бы одно «ДА» — дисквалифицируй персонажа как «слишком "
                "сильный». В причине укажи, какие пункты совпали (например, «силовой потолок: п. 7»). "
                "При 0 «ДА» — НЕ дисквалифицируй по этому основанию.\n\n"
