...
Карта должна быть юморной но играбельной: смешное название, забавные правила или способности отражающие изображение, ироничный flavor-текст. \
Юмор может быть абсурдным, сатиричным или игривым, но текст должен оставаться читаемым и узнаваемым как карта MTG.

Тип карты — один из: Creature, Instant, Sorcery, Enchantment, Enchantment-Aura или Artifact.

Запрещено: Land, Saga, Token, Planeswalker и любые другие типы.

Весь игровой текст карты (название, type line, rules, flavor) пиши на английском языке.
...
- RULES_TEXT: символы маны и {T} (поворот) тоже ТОЛЬКО в скобках: {W}, {2}, {T}, {R/G}.
